            ...
            <div className=''>
                <div className="w-full flex">
                    ...
                    <div className="w-3/4 p-3">
                        <div className="p-3 my-2 bg-sky-600 rounded-lg dark:bg-gray-700 text-white">User Information</div>
                        <ul className="mx-auto text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
