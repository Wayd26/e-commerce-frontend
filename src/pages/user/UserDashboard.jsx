...
import Menu from '../../components/nav/AppMenu'
        ...
        <>
            ...
            <div className='container'>
                <div className="w-full h-sreen flex">
                    ...
                    <div className="w-3/4">
                        <div className="sm:w-5/6 mx-auto p-3 mt-2 mb-2 bg-sky-600 rounded-lg dark:bg-gray-700 text-white">User Information</div>
                        ...
                        <ul className="sm:w-3/4 mx-auto text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
